...
params:
  hill_data: NULL
  hill_active: NULL
  most_recent_hill_record: NULL
  hunt_data: NULL
  hunt_active: NULL
  most_recent_hunt_record: NULL
---
...
most_recent_entry <- most_recent_hill_record
```

## Hill `r get_active_text(hill_active)`
...
most_recent_entry <- most_recent_hunt_record
```

## Hunt `r get_active_text(hunt_active)`
